...
function multiplyArray(multArr) { 
    let result = multiply(multArr[0],multArr[1]);
    let ans = multiply(result[0],multArr[2])[0];
    return[ans,`The numbers ${testArray} have a product of ${ans}.`];
}
...
function multiplyAnyArray(dynamicArray) { 
    ...
    for (let i=0;i<dynamicArray.length ;i++){
        l = multiply(l,dynamicArray[i])[0];
    }
    
return [l,`The numbers ${dynamicArray} have a product of ${l}.`];
// console.log( [`The numbers ${dynamicArray} have a product of ${l}.`]);
}
