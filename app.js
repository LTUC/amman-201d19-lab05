...
function sumArray(sumArr) { //eslint-disable-line
  ...
  {
    result += sumArr[i];
    resultText += sumArr[i].toString();
    if(i !== (sumArr.length - 1))
    {
      resultText +=',';
    }
  }
  return [result, resultText +' was passed in as an array of numbers, and ' + result + ' is their sum.'];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  {
    result *= multArr[i];
    resultText += multArr[i].toString();
    if(i !== (multArr.length - 1))
    {
      resultText +=',';
    }
  }
  return [result, 'The numbers ' + resultText +' have a product of ' + result + '.'];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(let i = 0; i < dynamicArray.length; i++)
  {
    ...
    resultText += dynamicArray[i].toString();
