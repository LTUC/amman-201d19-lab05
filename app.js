...
{ 
  let sumProduct = [a+b+c, a*b*c];
  return [sumProduct[0], sumProduct[1], a + ' and ' + b + ' and ' + c + ' sum to ' + sumProduct[0] + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + sumProduct[1] + '.' ] ;
}
...
//console.log(multiplyArray([4,7,0])) ;
...
//console.log(multiplyAnyArray([7,4,6,12,15]));
// Here is the test for multiplyArray(); uncomment it to run it
