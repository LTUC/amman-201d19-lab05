...
function multiply(a, b) {
    let result = a * b;
    let resultString = 'The product of ' + a + ' and ' + b + ' is ' + result + '.';
    return [result, resultString];
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    let sumResult = a + ' and ' + b + ' and ' + c + ' sum to ' + (a + b + c) + '.';
    let productResult = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + (a * b * c) + '.';
    return [sum(a, b)[0] + c, multiply(a, b)[0] * c, sumResult, productResult];
}
