...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let result = 0;
  for (let i=0 ; i<testArray.length ; i++){
      result = sum(testArray[i],result)[0];
  }
...
function multiplyArray(multArr) { //eslint-disable-line
  let result=1;
    for (let i=0; i< productArray.length; i++){
        result = multiply(productArray[i],result)[0]
    }
    return [result,'The numbers '+productArray+' have a product of '+result+'.']
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (let i=0; i<testDynamicArray.length; i++){
      result = multiply(testDynamicArray[i],result)[0];
  }
  return [result,'The numbers '+testDynamicArray+' have a product of '+result+'.']
