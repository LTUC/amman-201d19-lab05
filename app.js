...
let mult = multArr[0]*multArr[1]*multArr[2];
...
let mult =1;
 ...
 return[mult ,'The numbers '+dynamicArray[0]+','+dynamicArray[1]+','+dynamicArray[2]+','+dynamicArray[3]+','+dynamicArray[4]+' have a product of '+mult+'.']
}
