...
let z=multiply(testDynamicArray[0],testDynamicArray[1])[0];
let x=multiply(testDynamicArray[2],testDynamicArray[3])[0];
let f=multiply(z,x)[0];
let s=multiply(f,testDynamicArray[4])[0];
// console.log('this is s',s);
return[s,'The numbers '+testDynamicArray+' have a product of '+s+'.'];
}
